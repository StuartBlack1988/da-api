...
class AddPrivilegeProfile004 {
    ...
    public function down($db) {
        ...
        $db->exec("
            ALTER TABLE `ReceptionistDetails` ADD COLUMN `privilegeId` INT NULL, ADD FOREIGN KEY (`privilegeId`) REFERENCES `Privileges`(`privilegeId`);
            ALTER TABLE `PracticeManagerDetails` ADD COLUMN `privilegeId` INT NULL, ADD FOREIGN KEY (`privilegeId`) REFERENCES `Privileges`(`privilegeId`);
            ALTER TABLE `DietitianDetails` ADD COLUMN `privilegeId` INT NULL, ADD FOREIGN KEY (`privilegeId`) REFERENCES `Privileges`(`privilegeId`);
            ALTER TABLE `PatientDetails` ADD COLUMN `privilegeId` INT NULL, ADD FOREIGN KEY (`privilegeId`) REFERENCES `Privileges`(`privilegeId`)
        ");
